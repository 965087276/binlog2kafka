...
//	        topic = entry.getHeader().getSchemaName() + "_" + entry.getHeader().getTableName();
            ...
            for (RowData rowData : rowChage.getRowDatasList()) {
                if (eventType == EventType.DELETE) {
                    data.putAll(makeColumn(rowData.getBeforeColumnsList()));
                }
                else {
                    data.putAll( makeColumn(rowData.getAfterColumnsList()));
                }
                ...
                ++cntNum;
//                System.out.println("the number of data: " + cntNum);
            }
            data.clear();
        }
        return ret;
    ...
    private static Map<String, Object> makeColumn(List<Column> columns) {
        Map<String, Object> row = new HashMap<>();
        for (Column column : columns) {
            String col = column.getName().toLowerCase();
